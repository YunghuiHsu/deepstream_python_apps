## Update
### 26/05/2023
- Capture and display confidence scores on screen (`deepstream_test1_rtsp_in_rtsp_out_getconf.py`)
- Add custom model configuration file (YOLOv7) dstest1_pgie_yolov7_config.txt
